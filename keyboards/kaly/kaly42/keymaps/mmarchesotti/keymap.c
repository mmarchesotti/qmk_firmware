...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT_split_3x6_3(
        _______, _______, MS_BTN3, MS_UP,   MS_BTN1, MS_WHLU,           C(KC_UP),   KC_PGDN,    KC_UP,      KC_PGUP,     C(KC_DEL), C(KC_BSPC),
        _______, _______, MS_LEFT, MS_DOWN, MS_RGHT, MS_WHLD,           KC_HOME,    KC_LEFT,    KC_DOWN,    KC_RIGHT,    KC_END,    KC_INSERT,
        _______, _______, MS_BTN6, MS_BTN5, MS_BTN2, MS_BTN4,           C(KC_DOWN), C(KC_LEFT), C(KC_BSPC), C(KC_RIGHT), KC_ENT,    KC_PRINT_SCREEN,
                                        MS_ACL2,MS_ACL1, MS_ACL0,    _______, _______,  _______
    ),
     /*
      *  ┌───┬───┬───┬───┬───┬───┐        ┌───┬───┬───┬───┬───┬───┐
